          ...
          <WorkspaceHorizontalSplit
            ...
            right={
              project ? (
                ...
                <div className="flex h-full min-h-0 flex-col items-center justify-center border-l border-border/60 bg-bg-base/40 px-4 text-center text-ui-mono text-[12px] text-text-muted">
                  加载设计文档…
                </div>
              )
            }
